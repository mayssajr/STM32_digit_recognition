...
#define AI_NETWORK_MODEL_SIGNATURE     "0x69aca7ed8136bd55ff66d07eb2bec3a9"
...
#define AI_TOOLS_DATE_TIME   "2025-08-29T17:35:16+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 24, 2), AI_STRIDE_INIT(4, 4, 4, 64, 1536),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 26, 26), AI_STRIDE_INIT(4, 4, 4, 32, 832),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  17, 0x0,
  AI_SHAPE_INIT(4, 2304, 64, 1, 1), AI_STRIDE_INIT(4, 4, 9216, 589824, 589824),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 597672, 1, 1),
    597672, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 25760, 1, 1),
    25760, NULL, NULL),
  ...
  &conv2d_conv2d_layer, 0x19455e95, NULL)
